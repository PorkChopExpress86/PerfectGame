...
def test_daemon_poll_uses_fixed_interval_when_polling(mock_run, mock_should_poll):
    mock_run.return_value = [{"Date": "Apr 26", "Type": "Upcoming"}]
    mock_should_poll.return_value = MagicMock(should_poll=True, next_poll_at=None)
