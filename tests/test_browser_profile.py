"""
tests/test_browser_profile.py - Tests for shared.browser_profile module.
"""
...
class TestGetRandomHeaders:
    ...
    def test_chrome_ua_has_sec_headers(self):
        ...
        with patch("shared.browser_profile.random.choice", side_effect=[chrome_ua, "en-US,en;q=0.9", "https://www.perfectgame.org/"]):
            headers = get_random_headers()
    ...
    def test_firefox_ua_no_sec_headers(self):
        ...
        with patch("shared.browser_profile.random.choice", side_effect=[firefox_ua, "en-US,en;q=0.9", "https://www.perfectgame.org/"]):
            headers = get_random_headers()
    ...
    def test_safari_ua_no_sec_headers(self):
        ...
        with patch("shared.browser_profile.random.choice", side_effect=[safari_ua, "en-US,en;q=0.9", "https://www.google.com/"]):
            headers = get_random_headers()
        assert "Sec-CH-UA" not in headers
...
class TestRandomDelay:
    ...
    @patch("shared.browser_profile.time.sleep")
